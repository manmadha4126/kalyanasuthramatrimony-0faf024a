  ...
  return (
    <section className="py-20 section-rose relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Contact strip */}
        <div className="mt-12 py-4 px-6 text-center opacity-100 shadow-2xl rounded-3xl border-8 border-slate-500 border-solid bg-fuchsia-100 text-primary" style={{ background: "hsl(var(--burgundy-light))" }}>
