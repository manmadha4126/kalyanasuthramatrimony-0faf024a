        ...
        <div className="container mx-auto px-4 py-10 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <motion.div
              ...
              <div className="relative aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] max-w-lg sm:max-w-xl rounded-3xl overflow-hidden shadow-2xl mx-[3px] my-0 px-0 py-0" style={{ border: "4px solid hsl(var(--gold-accent) / 0.4)" }}>
