  ...
  return (
    <section id="home" className="relative w-full" style={{ marginTop: "80px" }}>
      ...
      <div className="relative w-full overflow-hidden" style={{ background: "linear-gradient(135deg, hsl(230, 40%, 22%) 0%, hsl(250, 35%, 30%) 20%, hsl(270, 30%, 35%) 40%, hsl(25, 45%, 40%) 65%, hsl(35, 50%, 45%) 80%, hsl(220, 35%, 30%) 100%)" }}>
        ...
        <div className="container mx-auto px-4 py-6 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-12 items-center">
            ...
            <motion.div
              ...
              {/* Decorative line */}
              <div className="flex items-center gap-2 justify-center lg:justify-start mb-3 lg:mb-4">
                <div className="w-8 lg:w-10 h-px" style={{ background: "hsl(var(--gold-accent))" }} />
                <p
              ...
              <h1
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-3 lg:mb-4"
              ...
              {/* CTA Buttons */}
              <div className="flex items-center justify-center lg:justify-start gap-2.5 lg:gap-3 flex-wrap">
                <a
                  href="/register"
                  className="inline-flex items-center gap-2 px-5 py-2.5 lg:px-6 lg:py-3 rounded-xl text-sm lg:text-sm font-bold text-white transition-all duration-300 hover:scale-105 hover:shadow-xl"
